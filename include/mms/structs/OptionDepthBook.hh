...
template <class OptionStructT, sz_t NO_OPTIONS>
...
public:
    ...
    auto get_block(this const auto& self, sz_t idx) noexcept;

    template <OptionSide SIDE>
    auto get_side(this const auto& self, const sz_t idx) noexcept;
...
template <class OptionStructT, sz_t NO_OPTIONS>
auto OptionDepthBook<OptionStructT, NO_OPTIONS>::get_block(this const auto& self, const sz_t idx) noexcept
{
...
template <class OptionStructT, sz_t NO_OPTIONS>
template <OptionSide SIDE>
auto OptionDepthBook<OptionStructT, NO_OPTIONS>::get_side(this const auto& self, const sz_t idx) noexcept
{
